...
layui.define(['table', 'form'], function (exports) {
    ...
    //股票热点
    table.render({
        elem: '#LAY-cms-stockhotspot-list'
        , url: '/cms/stockhotspot/list'
        , where: {categoryId: 2}
        , headers: {
        ...
        , cols: [[
            ...
            , {field: 'coverInfo', title: '封面', align: "center", templet: '#coverTpl'}
    ...
    //监听工具条
    table.on('tool(LAY-cms-stockhotspot-list)', function (obj) {
        var data = obj.data;
        if (obj.event === 'details') {
            ...
            admin.popup({
                ...
                ,success: function(layero, index){
                    view(this.id).render('cms/article/edit', data).done(function(){
                        $.get(
                            "/cms/getCmsByCmsId",
                            { cmsId: data.cmsId},
